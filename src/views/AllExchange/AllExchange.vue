...
<template>
  <div class="all-exchange clearfix">
      ...
      <div>
        ...
        <div class="set-1px-b" v-for="(item,index) in newDbPageList" :key="index">
          ...
          <div v-show="item.showContent">
            ...
            <cell class="content-cell" :border-intent="false" title="撤销理由：" v-if="item.state === 2"
                  :value="item.revocationDesc"></cell>
    ...
    <FooterTabbar :tabbar-index="3"></FooterTabbar>
  </div>
</template>

<script>
  import FooterTabbar from '@/components/FooterTabbar'
  import {Cell, CellBox, Divider, Group, Scroller, XHeader} from "vux";
        ...
        this.$api.mainInterface
          ...
          .then(res => {
            ...
            if (res.success) {
              ...
              this.$router.replace({name: 'blank', query: {name: 'AllExchange'}});
            } else {
