...
<template>
  <div class="userInfo">
    ...
    <Group title="当前项目">
      <cell class="cell" :title="this.$route.query.projectName"></cell>
    </Group>
    <br><br>
  ...
  export default {
      ...
      this.$api.userInterface
        ...
        .then(res => {
          ...
          if (res.data.success) {
            ...
            this.$vux.toast.show({ type: "cancel", text: "加载所有项目失败" });
          }
        })
        .catch(err => {
    ...
    methods:{
      requestSwitch(pId){
        ...
        this.$router.push({name:'userInfo',query:{userId:this.$route.query.uid,projectId:pId,projectList:this.projectList}});
